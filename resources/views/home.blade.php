                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>Welcome {{ Auth::user()->first_name }} {{ Auth::user()->last_name }} to <i class="bi bi-emoji-heart-eyes"></i> your dashboard!</h3>
                        ...
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                ...
                                <p class="text-end">with <i class="bi bi-lightning"></i> <a href="">Blue Box Space</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
