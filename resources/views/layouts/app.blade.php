...
<head>
    ...
    <title>{{ config('app.name', 'BJS Blue Box') }}</title>

    <link rel="shortcut icon" href="{{asset('favicon_io/BlueBoxCube.jpg')}}">
    <link rel="shortcut icon" sizes="16x16" href="{{asset('favicon_io/BlueBoxCube.jpg')}}">
    <link rel="shortcut icon" sizes="32x32" href="{{asset('favicon_io/BlueBoxCube.jpg')}}">
    <link rel="apple-touch-icon" href="{{asset('favicon_io/')}}">
    <link rel="icon" href="{{asset('favicon_io/BlueBoxCube.jpg')}}" sizes="192x192">
    <link rel="icon" href="{{asset('favicon_io/BlueBoxCube.jpg')}}" sizes="512x512">
    <!-- Scripts -->
