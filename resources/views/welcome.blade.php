        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <h1 class="text-gray-900 dark:text-white"><img src="{{asset('favicon_io/BlueBoxCube.jpg')}}" class="mr-2" height="50px" width="50px"><span style="font-size: 45px; color: #007ffd;">BLue Box </span> - <small>Powered by &nbsp;</small></h1>
                    <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">
                        <g clip-path="url(#clip0)" fill="#FC00b1">
                    ...
                    <span class="ml-4" style="font-size: 50px; color:#231720;">+</span>
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-center sm:ml-0">
                        ...
                        Developed by <a href="http://"> Mane Brothers - LATITUDE</a>
                    </div>
                </div>
            </div>
        </div>
